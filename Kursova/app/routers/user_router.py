...
async def get_one_playlist(user_id:str, playlist_id:int, playlist_service: PlaylistService = Depends(get_playlist_service)):
...
@router.post("/playlist/{playlist_id}/songs/{song_id}", status_code=status.HTTP_201_CREATED)
